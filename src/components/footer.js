...
function Footer() {
  return (
    <div
      className="bg-white shadow-none items-center"
    ...
    >
      <div
        ...
        style={{ maxWidth: "85rem", margin: "0 auto", padding: "40px 16px" }}
      >
        {/* Left: Logo */}
        ...
        <div className="flex justify-end w-1/4 gap-3">
          <IconButton
            className="rounded-md hover:shadow-none shadow-none"
            style={{ backgroundColor: "#F6E6FF", color: "#AE6BD1" }}
          >
            <svg
              fill="#AE6BD1"
              width="16px"
